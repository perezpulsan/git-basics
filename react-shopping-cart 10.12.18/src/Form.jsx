  ...
  render() {
    return (
      <div className="col-md-8 order-md-1">
        ...
        <form className="needs-validation" noValidate="" data={this.props.form} onChange={this.props.onChange}>
          <div className="row">
          ...
          <div className="mb-3">
            ...
            <div className="input-group">
              ...
              <input
                ...
                required=""
              />
              <div className="w-100 invalid-feedback">Your username is required.</div>
            </div>
          </div>
